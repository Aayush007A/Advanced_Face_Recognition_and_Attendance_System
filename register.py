...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"college_images\160997.jpg")
        ...
        loginbtn=Button(frame,text="Login", command=self.exit,font=("times new roman",15,"bold"),bd=0,relief=RIDGE,
                        fg="#fff",
        ...
        if (self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_cnum.get()=="" or self.var_email.get()=="" or self.var_ssq.get()=="Select" or self.var_sa.get()=="" or self.var_pwd.get()=="" or self.var_cpwd.get()==""):
            ...
            try:
                ...
                if row!=None:
                    ...
                    mycursor.execute("insert into register_user values(%s,%s,%s,%s,%s,%s,%s)",(
                    self.var_fname.get(),
                    self.var_lname.get(),
                    self.var_cnum.get(),
                    self.var_email.get(),
